...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.leftTrigger().or(cojoystick.L2()).onTrue(new InstantCommand(() -> intakePivot.setPosition(-7.3))).onFalse(new InstantCommand(() -> intakePivot.setPosition(-3)));
        ...
        joystick.rightBumper().onTrue(new InstantCommand(() -> shooter.setVelocity(-30))).onFalse(new InstantCommand(() -> shooter.setVelocity(0)));

        joystick.rightTrigger().or(cojoystick.R2()).onTrue(new InstantCommand(() -> agitator.startAgMotor(-0.3))).onFalse(new InstantCommand(() -> agitator.stopAgMotor()));
        joystick.rightTrigger().or(cojoystick.R2()).onTrue(new InstantCommand(() -> indexer.setVelocity(30))).onFalse(new InstantCommand(() -> indexer.setVelocity(0)));
